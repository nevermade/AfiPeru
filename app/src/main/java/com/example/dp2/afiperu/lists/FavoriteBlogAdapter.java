 ...
 */
public class FavoriteBlogAdapter extends BaseArrayAdapter<BlogsItem> {
    ...
    public FavoriteBlogAdapter(Context context, BaseFragment fragment, List<BlogsItem> objects) {
