 ...
 */
public class UsersAdapter extends BaseArrayAdapter<Users> {

    public UsersAdapter(Context context, BaseFragment fragment, List<Users> objects) {
        super(context, fragment, R.layout.users_list_item, objects);
    }

    @Override
    public void prepareItemView(final View convertView,final Users item,final int position) {
