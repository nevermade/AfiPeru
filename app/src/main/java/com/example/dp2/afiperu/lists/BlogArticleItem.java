...
public class BlogArticleItem implements Serializable {
    ...
    public BlogArticleItem(String title, long uploadDate, String content, int authorIconId, String authorIconURL,
